...
const masterList = [
	{ header: "Master List of Flow Moves Website", desc: (<> <a rel="noopener noreferrer" className="resource-link" href="https://stuyflow.github.io/flow-masterlist" target="_blank">A website</a> for learning poi, staffs, and whips. Each move is assigned a difficulty and most of them have links to tutorials!</>) },
	{ header: "Master List of Flow Moves Spreadsheet", desc: (<> <a rel="noopener noreferrer" className="resource-link" href="https://docs.google.com/spreadsheets/d/1SX_NGhIfmVFl4-BJUh9qQsWLR08Ov3D6Yl_rZIXnvNQ/edit#gid=109028202" target="_blank">A large list of moves</a> for poi, staffs, whips, and other props.</>) },
