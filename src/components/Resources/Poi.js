...
const equipment = [
	...
	{ name: (<> <a rel="noopener noreferrer" className="item-name" href="https://flowtoys.com/podpoi" target="_blank">Podpoi v2 ($134.95)</a></>), desc: ["Same as Podpoi v2 with Capsule Handles, but the handles are knobs", "Center of weight is different due to the lightness of the knob", "Good for stalls and tosses", "Handles can be bought separately"], img: "poi/podpoi.jpg", link: "https://flowtoys.com/podpoi" },
	...
	{ name: (<> <a rel="noopener noreferrer" className="item-name" href="https://flowtoys.com/fuzzy-poi-rainbow" target="_blank">Fuzzy Poi ($25.00)</a></>), desc: ["Recycled tennis balls, covered by a fuzzy sleeve", "Has the same weight as Podpoi"], img: "poi/fuzzy.jpg", link: "https://flowtoys.com/fuzzy-poi-rainbow"}
]
